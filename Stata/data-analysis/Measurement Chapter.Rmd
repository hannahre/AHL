...
In this section, I will present exploratory factor analysis results. While data screening 
...
corrplot.mixed(het.mat, tl.pos = "lt", tl.col = "black", tl.cex = .8, number.cex = .5, lower.col = "black")
