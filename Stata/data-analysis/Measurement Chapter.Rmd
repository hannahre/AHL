...
CAM <- c("Acupuncture", "Prayer", "Ayurveda", "Biofeedback", "Chiropractic", "Deep breathing", "Energy healing", "Folk medicine", "Guided imagery", "Herbal therapy", "Homeopathy", "Hypnosis", "Massage", "Meditation", "Naturopathy", "Healing ritual", "Vitamins", "Special Diet")
UK <- c("")
NCCAM <- c("Alternative Medical Systems", "Mind-Body Treatments", "Alternative Medical Systems", "Mind-Body Treatments", "Manipulative Treatements", "Mind-Body Treatments", "Energy Medicine", "Alternative Medical Systems", "Mind-Body Treatments", "Biologically Based Practices", "Alternative Medical Systems", "Mind-Body Treatements", "Manipulative Treatments", "Mind-Body Treatments", "Alternative Medical Systems", "Mind-Body Treatments", "Biologically Based Practices", "Biologically Based Practices")
NCCIH <- c("Other", "Not included", "Other", "Not included", "Physical", "Psychological and Physical", "Not included", "Other", "Psychological and Physical", "Nutrional", "Other", "Psychological", "Physical", "Psychological and Physical", "Other", "Psychological", "Nutritional", "Nutritional")
Ayers <- c("Manipulative Treatments", "")
domains.df <- data.frame(CAM, NCCAM)
domains.df
kable(domains.df, caption = "")
```
