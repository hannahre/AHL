...
acams15_MLVarimax1_list <- factor_results(data = het.mat, rotate = "varimax", fm = "ml", n.obs = nrow(acams), nfactors = 1)
...
fa.diagram(acams15_MLVarimax1, cut = .299, sort = TRUE)
```

```{r, echo = FALSE}
# Reliability: Add reliability values 
acams15_MLVarimax1_list[["reliabilityF1"]] <- kr20(acams)
```
