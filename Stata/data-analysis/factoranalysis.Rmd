...
cor.plot(het.mat13, numbers=T, upper=FALSE, main = "Tetrachoric Correlations", show.legend = TRUE, xlas = 2)
```
...
```
```{r, echo = FALSE, message = FALSE}
nofactors2 <- fa.parallel(acams13, fm = "ml", fa = "fa", main = "Parallel Analysis Scree Plots", cor = "tet")
```
...
```{r, echo = FALSE}
exprayheal_3 <- fa(r = het.mat13, nfactors = 3, n.obs=nrow(acams), rotate = "oblimin", fm = "ml")
...
```{r, echo = FALSE}
exprayheal_4 <- fa(r = het.mat13, nfactors = 4, n.obs=nrow(acams), rotate = "oblimin", fm = "ml")
