...
dir <- "C:/Users/hanna/Documents/git/AHL/Stata/data-cleaning"
setwd(dir)
```


Coding set up: Code for each variable is shown together across waves (e.g. alcohol coding for all waves is displayed together). 
	
Variable naming conventions: 
Waves: each variable starts with a letter denoting the wave it belongs to a=wave 1, b=wave2, 3=wave3
