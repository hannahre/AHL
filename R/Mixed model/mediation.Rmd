...
Most model fit statistics indicated good fit for the mind-body medicine models. The chronic pain (CFI = 0.961; TLI = 0.906; RMSEA = 0.03, SRMR
...
At least one of the fit statistics was low for all of the manipulative treatment models. 
TLI was low in the chronic pain (CFI = 0.948; TLI = 0.873; RMSEA = 0.028; SRMR = 0.014), depression/anxiety (CFI = 0.947; TLI = 0.871; RMSEA = 0.031; SRMR = 0.015), and chronic conditions models (CFI = 0.941; TLI = 0.817; RMSEA = 0.049; SRMR = 0.023).
CFI and TLI were low in the self-reported health model (CFI = 0.842; TLI = 0.614; RMSEA = 0.066; SRMR = 0.031). All other fit statistics indicated good model fit.

### SES and CAMs 

*Hypothesis 1* predicts that SES will be positively related to CAM use. Results do not support *Hypothesis 1a*. I find that income at wave 1 does not predict CAM use at waves 2 or 3. Results support *Hypothesis 1b*. I find that education at wave 1 is positively related to total CAMs (*b* = 0.139-0.145), use of mind-body medicines (*b* = 0.340), use of alternative medical systems (*b* = 0.275), and use of physical and nutritional approaches (*b* = 0.179) at waves 2. Similarly, education at wave 1 is positively related to total CAMs (*b* = 0.056-0.062), use of mind-body medicines (*b* = 0.227-0.230), use of alternative medical systems (*b* = 0.148-0.160), and use of physical and nutritional approaches (*b* = 0.140-0.162) at wave 3. These results provide support for Health Lifestyle Theory and Human Capital Theory.
...
Mediation effects are indicated by a significant indirect effect coefficient. The indirect effect is the product of the path coefficients between the independent variable and mediator, and between the mediator and outcome. Results from 6 models show a mediation effect for CAM use, though the effect of CAMs on health outcomes was not in the expected direction. For example, Total CAMs mediates the relationship between education and sum of chronic conditions. As stated in the previous sections, education has a negative effect on sum of chronic conditions at wave 3 and a positive effect on total CAMs used at wave 2. Total CAMs at wave 2 has a positive effect on chronic conditions, indicating that more CAMs used at wave 2 is associated with an increase in chronic conditions at wave 3 (*b* = 0.031, 95% CI: 0.019, 0.043, p < 0.001). This is in opposition with the Health Lifestyles Theory prediction that CAM use will be related to better health. GSEM results also show that the indirect (b = 0.005, 95% CI: 0.003, 0.006 p < 0.001) and total (b = -0.034, 95% CI: -0.57, -0.011, p < 0.010) effects of education on chronic conditions via total CAMs are significant.

Total CAMs mediate the relationship between education and chronic pain. As stated in previous sections, education is negatively related to chronic pain wave 3 and positively related to total CAMs used at wave 2. Total CAMs at wave 2 is positively related to chronic pain at wave 3 (SEM: b = 0.011, 95% CI: 0.001, 0.021, p < 0.050; GSEM: b = 0.058, 95% CI: 0.010, 0.106, p < 0.050), indicating use of more CAMs at wave 2 is associated with higher odds of reporting chronic pain at wave 3. Note, however, that health lifestyles theory would predict a negative relationship between health behavior (CAM use) in wave 2 and health problems (chronic pain) in wave 3. Results from the GSEM show a significant positive indirect effect for education on chronic pain via total CAMs (b = 0.008, 95% CI: 0.001, 0.015, p < 0.050). The total effect is negative but not significant. 

Total CAMs used also mediate the relationship between education and depression/anxiety. The relationship between education and health and total CAMs is the same as observed in previous models, and similarly each additional CAM used at wave 2 is associated with an increase in the log odds of reporting depression/anxiety at wave 3 Total CAMs used at wave 2 has a positive effect on depression/anxiety at wave 3 (SEM: b = 0.009, 95% CI: 0.001, 0.017, p < 0.050; GSEM: b = 0.065, 95% CI: 0.008, 0.123, p < 0.050). GSEM results show a significant positive indirect effect of education on depression and anxiety mediated by total CAMs used (b = 0.009, 95% CI: 0.009, 0.017, p < 0.050) and a negative total effect (b = -0.114, 95% CI: -0.227, -0.001, p < 0.050).
...
Use of physical and nutritional approaches mediates the relationship between education and sum of chronic conditions, as well as the relationship between education and chronic pain, following the same pattern observed in the models reviewed above. Education is negatively related to sum of chronic conditions and chronic pain at wave 3, and positively related to use of physical and nutritional approaches at wave 2. Use of physical and nutritional approaches has a positive effect on sum of chronic conditions at wave 3 (SEM: b = 0.316, 95% CI: 0.095, 0.595, p < 0.050; GSEM: b = 0.162, 95% CI: 0.111, 0.212, p < 0.001) and education has a positive indirect effect on chronic conditions via use of physical and nutritional approaches (SEM: b = 0.013, 95% CI: 0.003, 0.028, p < 0.050; GSEM: b = 0.029, 95% CI: 0.013, 0.045, p < 0.001). Results similarly show a positive relationship between using physical and nutritional approaches at wave 2 and reporting chronic pain at wave 3 (GSEM: b = 0.292, 95% CI: 0.093, 0.490, p < 0.010) and a positive indirect effect for of education on chronic pain mediated by use of physical and nutritional approaches (GSEM: b = 0.052, 95% CI: 0.009, 0.095, p < 0.050). The total effects are negative and not significant. 

These results do not support *Hypothesis 3a* and contradict *Hypothesis 3b* generated by HLT. There are some mediating effect of CAMs, but these effects operate in the opposite direction HLT predicts. CAM use at wave 2 is consistently associated with worse health at wave 3. This pattern appears in models without a mediation effect as well. 

### Health as a Mediator of the SES-CAM Relationship

Findings presented in the previous section indicate that CAMs are associated with worse health. It is possible that people are using CAMs to address health problems that they already have, rather than to prevent health problems or to improve well-being. 

This suggests that chronic conditions may act as an alternative pathway to CAM use, which is higher among high-SES respondents and among respondents with chronic conditions, who are less likely to be high-SES.
...
This chapter examined the relationship between SES and CAM use, as well as possible mediation models for the relationships between SES, CAM use, and health. Higher levels of education were consistently associated with greater levels of CAM use across analyses. The relationship between income and CAM use was less consistent, most often becoming non-significant after accounting for the influence of education. Both income and education were overall related to better health outcomes across analyses, confirming the well established SES gradient in health. However, CAM use did not mediate the relationship between income and health. Given the inconsistent relationship between income and CAM use in analyses, this is to be expected. CAM use was largely not a significant mediator of the relationship between education and health. When analyses showed a mediation effect, it was in the opposite of the expected direction. Total CAMs used at wave 2 was associated with an increase in reported chronic conditions, incidence of chronic pain, and incidence of depression and anxiety at wave 3, suggesting that individuals turn to CAM when they experience health problems rather than using CAM to prevent health problems and improve overall well-being. Use of alternative medical systems at wave 2 was associated with an increase in chronic conditions at wave 3, and use of physical and nutritional approaches at wave 2 was associated with an increase in chronic conditions and increase in log odds of reporting chronic pain at wave 3.
