...
SumChron_W2 ~ LogIncome_W1 + Education_W1 + Sex_W1 + Age_W2 + Marital_W2 + HlthInsurance_W2 + HLSelf_W2 + Spiritual_W2 + Religion_W2 + MexicanHispanic_W2 + Black_W2 + OtherRace_W2
...
path_dia4 <- mark_sig(path_dia3, model.summ, alpha = c("(n.s.)" = 1.00, "*" = .05))

path_dia5 <- change_node_label(path_dia4,
