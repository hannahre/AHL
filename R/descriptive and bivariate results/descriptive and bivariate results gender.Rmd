---
title: "descriptive and bivariate results gender"
...
wave1.gender.df <- wave1[vars]

gender.cams.chisquares <- lapply(wave1.gender.df[-length(wave1.gender.df)], function(x) chisq.test(table(wave1$Sex_W1, x)))
gender.cams.chisquares
...
wave2.gender.df <- wave2[vars]

gender.cams.chisquares <- lapply(wave2.gender.df[-length(wave2.gender.df)], function(x) chisq.test(table(wave2$Sex_W2, x)))
gender.cams.chisquares
...
wave3.gender.df <- wave3[vars]

gender.cams.chisquares <- lapply(wave3.gender.df[-length(wave3.gender.df)], function(x) chisq.test(table(wave3$Sex_W3, x)))
gender.cams.chisquares
...
# Visualize data
library(ggpubr)
ggboxplot(wave1, x = "Sex_W1", y = "totalCams_W1",
          color = "Sex_W1", palette = c("#00AFBB", "#E7B800", "#FC4E07", "#3369FF", "#F633FF"),
          ylab = "Total Cams", xlab = "Sex")

# Visualize means by group
ggline(wave1, x = "Sex_W1", y = "totalCams_W1", 
       add = c("mean_se"),
       ylab = "Total Cams", xlab = "Sex")

# T test 
t.test(as.numeric(wave1$Sex_W1), wave1$totalCams_W1)
...
# Visualize data
library(ggpubr)
ggboxplot(wave2, x = "Sex_W2", y = "totalCams_W2",
          color = "Sex_W2", palette = c("#00AFBB", "#E7B800", "#FC4E07", "#3369FF", "#F633FF"),
          ylab = "Total Cams", xlab = "Sex")

# Visualize means by group
ggline(wave2, x = "Sex_W2", y = "totalCams_W2", 
       add = c("mean_se"),
       ylab = "Total Cams", xlab = "Sex")

# T test 
t.test(as.numeric(wave2$Sex_W2), wave2$totalCams_W2)
...
# Visualize data
library(ggpubr)
ggboxplot(wave3, x = "Sex_W3", y = "totalCams_W3",
          color = "Sex_W3", palette = c("#00AFBB", "#E7B800", "#FC4E07", "#3369FF", "#F633FF"),
          ylab = "Total Cams", xlab = "Sex")

# Visualize means by group
ggline(wave3, x = "Sex_W3", y = "totalCams_W3", 
       add = c("mean_se"),
       ylab = "Total Cams", xlab = "Sex")

# T test 
t.test(as.numeric(wave3$Sex_W3), wave3$totalCams_W3)
...
### Chi Squares
```{r, echo = FALSE}
vars <- c("mindbody", "pna", "altmed", "manipulative", "Sex_W1")
wave1.gender.df <- wave1[vars]

gender.factors.chisquares <- lapply(wave1.gender.df[-length(wave1.gender.df)], function(x) chisq.test(table(wave1$Sex_W1, x)))

gender.factors.chisquares
```
...
### Chi Squares
```{r, echo = FALSE}
vars <- c("mindbody", "pna", "altmed", "manipulative", "Sex_W2")
wave2.gender.df <- wave2[vars]

gender.factors.chisquares <- lapply(wave2.gender.df[-length(wave2.gender.df)], function(x) chisq.test(table(wave2$Sex_W2, x)))
...
### Chi Squares
```{r, echo = FALSE}
vars <- c("mindbody", "pna", "altmed", "manipulative", "Sex_W3")
wave3.gender.df <- wave3[vars]

gender.factors.chisquares <- lapply(wave3.gender.df[-length(wave3.gender.df)], 
                                    function(x) chisq.test(table(wave3$Sex_W3, x)))
