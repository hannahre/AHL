...
f <- cbind(YAcupuncture, YChiropractic, YEnergyHeal, YExerciseMove , YHerbal, 
           YVitamins, YHomeopathy, YHypnosis , YImageryTech, YMassage, 
           YRelaxMeditate, YSpecialDiet , YPraySpirit) ~ 1
...
set.seed(123)
test <- acl(cams.long.df, 6, f)
pooled.no.bio <- compare_classes_acl(test)
pooled.no.bio
```
# LCA pooled with biofeedback
```{r, echo = FALSE, results='hide'}
